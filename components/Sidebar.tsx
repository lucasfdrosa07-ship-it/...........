...
const Sidebar: React.FC<SidebarProps> = ({ 
  ...
  const handleResetKey = () => {
      if(confirm("Deseja remover sua Chave API salva e voltar ao login?")) {
      ...
      `}>
        ...
        <div className="p-4 bg-[#050505] pb-safe">
            <button 
                ...
                className="flex items-center gap-2 text-[10px] text-[#E50914] font-bold uppercase hover:text-red-400 transition-colors mb-2 w-full justify-center border border-[#E50914]/20 p-2 rounded"
            >
            ...
            <button 
                onClick={logout}
                className="flex items-center gap-2 text-[10px] text-[#444] font-bold uppercase hover:text-white transition-colors mb-4 w-full justify-center"
            >
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor" className="w-3 h-3">
